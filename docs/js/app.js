...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _backbone2.default.Application.extend({
	  ...
	  onStart: function onStart() {
	    ...
	    var collection = new _collections.NameCollection(this.nameList());

	    var view = new _views.MainView({ collection: collection });
	    region.show(view);
	  },
	  nameList: function nameList() {
	    return _underscore2.default.map(['Arlene', 'Alesia', 'Jacquelin', 'Britney', 'Christia', 'Jospeh', 'Maire', 'Irish', 'Rachael', 'Clemmie', 'Nickolas', 'Jestine', 'Josefina', 'Toi', 'Lise', 'Ramonita', 'Urlrike', 'Harrison', 'Raymon', 'Tawana', 'Sirena', 'Tisha', 'Christopher', 'Carolyn', 'Tyrone', 'Adella', 'Lionel', 'Faustino', 'Fermina', 'Breanne', 'Arnette', 'Cody', 'Mei', 'Katrice', 'Maricela', 'Illuminada', 'Kathern', 'Rita', 'Vernice', 'Dustin', 'Delcie', 'Noah', 'Reyna', 'Clora', 'Stanton', 'Alphonso', 'Temika', 'Marcella', 'Dolores', 'Marguerita', 'Sarah', 'Steve', 'Helen', 'Harry', 'Glendora', 'Huey', 'Christen', 'Reva', 'Leticia', 'Jacki', 'Cody', 'Annalisa', 'Doug', 'Delphia', 'Shalanda', 'Cathrine', 'Annice', 'Nicola', 'Barb', 'Una', 'Annita', 'Darwin', 'Therese', 'Isela', 'Jayna', 'Evelyne', 'Cherly', 'Harland', 'Myrtis', 'Evonne', 'Rema', 'Nicolle', 'Oretha', 'Alena', 'Bertha', 'Cesar', 'Minna', 'Astrid', 'Diedra', 'Krystin', 'Nanci', 'Arden', 'Mitchell', 'Marguerita', 'Breanne', 'Emiko', 'Alisia', 'Lashaunda', 'Cecily', 'Yan', 'Simone', 'Alyse', 'Anya', 'Marquis'], function (name) {
	      return { name: name };
	    });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.NameCollection = undefined;

	var _backbone = __webpack_require__(3);

	var _models = __webpack_require__(7);

	var NameCollection = exports.NameCollection = _backbone.Collection.extend({
	  model: _models.NameModel
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TimeModel = exports.FormModel = exports.NameModel = undefined;
	...
	var NameModel = exports.NameModel = _backbone.Model.extend({
	  idAttribute: 'name',
	  defaults: {
	    name: 'John',
	    surname: 'Smith'
	...
	var FormModel = exports.FormModel = _backbone.Model.extend({
	  defaults: {
	    search: ''
	  }
	});

	var TimeModel = exports.TimeModel = _backbone.Model.extend({
	  defaults: {
	    startTime: null,
	    endTime: null
	  },

	  calculateElapsed: function calculateElapsed() {
	    var _pick = this.pick('startTime', 'endTime');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormView = _backbone.View.extend({
	...
	var Person = _backbone.View.extend({
	  tagName: 'li',
	  template: _person2.default
	});

	var PersonList = _backbone.CollectionView.extend({
	  childView: Person,
	  tagName: 'ol',
	...
	var MainView = exports.MainView = _backbone.View.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(3), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, Backbone, $) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
		function search(terms) {
			var options = arguments.length <= 1 || arguments[1] === undefined ? { searchEmpty: false } : arguments[1];

			var noSearch = !terms && !options.searchEmpty;
			var collection = this._collection;
			var result = noSearch ? collection.models : this.filterFunction(collection, terms);
			this.set(result);
